          ...
          <div class="card">
            ...
            <h5 class="card-title text-center">  <span> Teachers </span></h5>
                  <?php if ($_SERVER ['REQUEST_METHOD'] =='POST') {
                    ...
                    $stmt = $con->prepare("UPDATE  teachers SET `Name`=? , Code=? , `Password`=?  WHERE Code =? ");
                    $stmt->execute(array( $Name , $Code  , $Password , $oldCode  ));
                ...
                if (isset($_GET['ID'])) {
                    ...
                    $update_stmt = $con->prepare("SELECT * FROM teachers WHERE Code = ?  ");
