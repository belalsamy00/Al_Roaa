            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body rtl">
                        <h1 class="card-title text-center fs-4 fw-bold"> <i class="fa-solid fa-thumbtack"></i> <?php echo "جدول المعلم/ة ".$teacher ; ?></h1> <hr>
                        <form id="form-2"class="mt-2 w-50 m-auto" method="GET" action="">
                            ...
                            <button class="btn btn-outline-primary fs-6 fw-bold w-100 mt-2 " >عرض جدول  معلم آخر</button>
                        </form>
                    </div>
                </div>
            </div>
