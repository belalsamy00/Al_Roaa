...
$last_month_plus_code_stmt->execute(array($session_code,"+",$last_month,$this_month,5));
...
$last_month_minus_code_stmt->execute(array($session_code,"-",$last_month,$this_month,5));
...
$pre_last_month_plus_code_stmt->execute(array($session_code,"+",$pre_last_month,$last_month,5));
...
$pre_last_month_minus_code_stmt->execute(array($session_code,"-",$pre_last_month,$last_month,5));
                        ...
                        <table  class="table table table-borderless text-center DataTable  ">
                          ...
                          foreach ($performance as  $value) { ?>
                            <tr>
                              ...
                              <td><a href="EvaluationAdminsDetails?Date=<?php echo $value['Date'] ?>"><script src="https://cdn.lordicon.com/bhenfmcm.js"></script> <lord-icon src="https://cdn.lordicon.com/dnmvmpfk.json" trigger="loop-on-hover"  colors="primary:#121331"style="width:25px;height:25px"></lord-icon></a></td>
                            </tr>
                          <?php }
                          ?>
                          </tbody>
