    ...
    <section class="section dashboard">
      ...
      <div class="col-lg-12">
          <div class="card">
            ...
            <div class="col-12">
              <div class=" info-card revenue-card ">
                ...
                <h5 class="card-title text-center">طلاب تجاوزا عدد حصص الباقة الخاصة بهم ولم يحن موعد تجديدهم </h5>
                  <button type="button" data-bs-toggle="collapse" data-bs-target="#GetExceedingOutDate" aria-expanded="false" aria-controls="GetExceedingOutDate" class="bg-secondary text-white card-icon w-50 rounded-pill border  border-dark d-flex align-items-center justify-content-center " >
                    <h6 class="text-center text-white rtl"><?php echo  count(GetExceedingOutDate($Who))."  "."طالب" ; ?></h6>
                  </button>
            ...
            <div class="card-body overflow-auto text-center"  id="GetExceedingOutDate" data-bs-parent="#myGroup">
              <table  class="table table-border table-hover text-center DataTable ">
                ...
                <tbody>
                  <?php  if (count(GetExceedingOutDate($Who)) == 0) { ?>  <td  class="fw-bold fs-5" colspan="3"> لا توجد طلبات مسجلة </td>  <?php } ?>
                  <?php 
                  if (count(GetExceedingOutDate($Who)) > 0) {

                    foreach ( GetExceedingOutDate($Who,1) as $value) {
