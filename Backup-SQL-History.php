<?php
function backupDatabaseAllTables($dbhost,$dbusername,$dbpassword,$dbname,$tables = "ArchivedHistory"){
    ...
    $handle = fopen('BackupFiles/'.date('Y-m-d - H-i-s')." - ".'Archived History-backup'." - ".$rand.'.php','w+');
    $File = 'BackupFiles/'.date('Y-m-d - H-i-s')." - ".'Archived History-backup'." - ".$rand.'.php';
        ...
        if(file_exists($File)){
            if(filesize($File)) {
                array_unshift($Data,(object)[
                    'Text' => " بنجاح "." Archived History SQL "." تم إنشاء النسخة الأحتياطية من ملف  ال "
                ]);
                array_unshift($Data,(object)[
                    'Status' => 1
                ]);
                ...
                array_unshift($Data,(object)[
                    'Text' => "لاكنه فارغ الدعم الفنى"." Archived History SQL "." تم إنشاء ملف ال "
                ]);
                array_unshift($Data,(object)[
                    'Status' => 0
                ]);
                ...
                array_unshift($Data,(object)[
                    'Text' => "راجع الدعم الفنى"." Archived History SQL "."لم يتم إنشاء ملف ال "
                ]);
                array_unshift($Data,(object)[
                    'Status' => 0
                ]);
